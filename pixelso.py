...
with col1:               # To display the header text using css style
   ...
   st.write('<p class="big-font">PIXELSO</p>', unsafe_allow_html=True)
...
if uploaded_file:
   ...
   with col2:
      ...
      filter = st.sidebar.radio('FILTERS:', ['Original','Gray Image','Black and White', 'Pencil Sketch', 'Blur Effect', 'Edge Enhance', 'Smooth', 'Contour Detection','Vignette Effect'])
      if filter == 'Original':
                  converted_img = image
                  st.image(image,width=300) 
